import 'dart:async';
import 'dart:io';
import 'package:anniversary/data/Messages.dart';
...
import 'package:anniversary/StatusList.dart';
import 'package:anniversary/widgets/CustomFBTextWidget.dart';
import 'package:anniversary/widgets/CustomFeatureCard.dart';
import 'package:anniversary/widgets/CustomFullCard.dart';
...
import 'package:anniversary/widgets/CustomTextReadMoreWidget.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: <Widget>[
            TriColorBackground(
                size: size, color: Colors.white70, isLeft: true),
            TriColorBackground(size: size, color: Colors.white70, isLeft: false),
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Anniversary Shayari",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Anniversary Wishes Images",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Generate Anniversary Cards",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Anniversary Status Wishes",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
